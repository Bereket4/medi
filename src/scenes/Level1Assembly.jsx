...
export function Level1Assembly({ onCorrect, onWrong }) {
  return (
    <div className="relative flex min-h-[100dvh] flex-col items-center justify-center px-6">
      ...
      >
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-fuchsia-300/90">Level 1 — Millennial Assembly</p>
        <h2 className="mt-4 font-display text-2xl font-extrabold sm:text-3xl">Only real ones born in 2000 can enter</h2>
        <p className="mt-3 text-sm text-white/55">No cap — the system is picky.</p>
