...
export const USE_CUSTOM_CAKE_GLTF = false
export const CUSTOM_CAKE_GLB_PATH = '/models/cake.glb'

/** Happy Birthday — candle blow only */
export const HBD_AUDIO_PATH = '/music/hbd.mp3'

/** Gallery / post-cake ambience — starts on cake→memory transition, runs through finale until replay */
...
/** Memory cards — swap `src` for real photos in `public/photos/` */
export const MEMORY_PHOTOS = [
  {
    src: '/img/one.jpg',
    caption: 'The smile-that-speaks-before-words🌸\nA little smile with a big personality',
  },
  {
    src: '/img/two.jpg',
    caption: 'The Gang Energy 😎\nThe "don\'t judge the face, I\'m actually nice" thing 😂',
  },
  {
    src: '/img/three.jpg',
    caption: 'Breaking News: Local Smile Too Powerful\nDentists are studying this masterpiece.',
  },
  {
    src: '/img/four.jpg',
    caption: 'The Calm & Cool One 🖤\nNo need for a big smile—sometimes the coolest moments are the ones where you simply exist.',
  },
]
